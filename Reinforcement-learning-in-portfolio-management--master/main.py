...
def session(config,args):
    ...
    if args['mode']=='train':
        train_start_date, train_end_date, test_start_date, test_end_date, codes = env.get_repo(start_date, end_date,
                                                                                               codes, market)
        env.get_data(train_start_date, train_end_date, features, window_length,market,codes,args['mode'])
        print("Codes:", codes)
        ...
        env.get_data(test_start_date,test_end_date,features,window_length,market,codes,args['mode'])
